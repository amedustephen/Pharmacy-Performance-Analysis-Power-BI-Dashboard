...
│   ├── interim/              # Transformed data that is not yet ready for modeling
│   ├── processed/            # Cleaned and transformed data
│   └── external/             # Reference data, lookup tables, third-party files
│
├── notebooks/                # Jupyter, R Markdown, or Colab notebooks
│
├── src/                      # Reusable .py, .R, or .sh processing files
│
├── queries/                  # SQL queries and standalone text files for easy code review, sharing and version control history
│   ├── sql/                  # SQL Queries
│   ├── powerquery/           # Raw M code scripts extracted from your queries
│   └── dax/                  # Standalone text files (.dax)
│
├── reports/                  # Final deliverables: PDFs, Word docs, slide decks
│
├── assets/                   # Exported charts, dashboard screenshots, ERD diagrams, images used in dashboards, etc.
│
